...
export default function Series() {
  ...
  const listSeries = useFetch(
    `${process.env.REACT_APP_URL_BASE}series?ts=1&apikey=${process.env.REACT_APP_API_KEY_MARVEL}&hash=${process.env.REACT_APP_HASH_IP}&orderBy=title&limit=${renderSeries}`
  );

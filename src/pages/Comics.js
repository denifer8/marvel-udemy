...
export default function Comics() {
  ...
  const listComics = useFetch(
    `${process.env.REACT_APP_URL_BASE}comics?ts=1&apikey=${process.env.REACT_APP_API_KEY_MARVEL}&hash=${process.env.REACT_APP_HASH_IP}&orderBy=title&limit=${renderComics}`
  );
